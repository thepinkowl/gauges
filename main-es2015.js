...
/* harmony import */ var _ionic_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic/core */ "./node_modules/@ionic/core/dist/esm/index.mjs");
/* harmony import */ var src_theme_animations_nav_transition__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/theme/animations/nav.transition */ "./src/theme/animations/nav.transition.ts");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mdIosTransitionAnimation", function() { return mdIosTransitionAnimation; });
/* harmony import */ var _ionic_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ionic/core */ "./node_modules/@ionic/core/dist/esm/index.mjs");
...
const animateBackButton = (rootAnimation, rtl, backDirection, backButtonEl, largeTitleBox, backButtonBox) => {
    ...
    const enteringBackButtonTextAnimation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
    const enteringBackButtonIconAnimation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
...
const animateLargeTitle = (rootAnimation, rtl, backDirection, largeTitleEl, largeTitleBox, backButtonBox) => {
    ...
    const clonedLargeTitleAnimation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
...
const mdIosTransitionAnimation = (navEl, opts) => {
    try {
        ...
        const rootAnimation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
        const enteringContentAnimation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
        rootAnimation
        ...
        if (leavingEl && navEl) {
            const navDecorAnimation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
        ...
        if (contentEl) {
            ...
            if (enteringTransitionEffectEl) {
                ...
                const enteringTransitionEffect = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                const enteringTransitionCover = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                const enteringTransitionShadow = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
        ...
        enteringToolBarEls.forEach(enteringToolBarEl => {
            const enteringToolBar = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            enteringToolBar.addElement(enteringToolBarEl);
            rootAnimation.addAnimation(enteringToolBar);
            const enteringTitle = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            enteringTitle.addElement(enteringToolBarEl.querySelector('ion-title')); // REVIEW
            const enteringToolBarButtons = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            ...
            const enteringToolBarItems = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            enteringToolBarItems.addElement(enteringToolBarEl.querySelectorAll(':scope > *:not(ion-title):not(ion-buttons):not([menuToggle])'));
            const enteringToolBarBg = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            enteringToolBarBg.addElement(shadow(enteringToolBarEl).querySelector('.toolbar-background')); // REVIEW
            const enteringBackButton = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            ...
            if (backDirection) {
                ...
                if (!translucentHeader) {
                    ...
                    enteringToolBarBg.fromTo('transform', (isRTL ? `translateX(-${SCREEN_WIDTH_PX})` : `translateX(${SCREEN_WIDTH_PX})`), 'translateX(0px)');
                }
                ...
                if (backButtonEl && !forward) {
                    const enteringBackBtnText = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                    enteringBackBtnText
        ...
        // setup leaving view
        if (leavingEl) {
            const leavingContent = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            ...
            if (backDirection) {
                ...
                leavingContent
                    .beforeClearStyles([OPACITY])
                    .fromTo('transform', `translateX(${CENTER})`, (isRTL ? `translateX(-${SCREEN_WIDTH_PX})` : `translateX(${SCREEN_WIDTH_PX})`));
                const leavingPage = leavingEl;
            ...
            if (leavingContentEl) {
                ...
                if (leavingTransitionEffectEl) {
                    ...
                    const leavingTransitionEffect = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                    const leavingTransitionCover = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                    const leavingTransitionShadow = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
            ...
            leavingToolBarEls.forEach(leavingToolBarEl => {
                const leavingToolBar = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                leavingToolBar.addElement(leavingToolBarEl);
                const leavingTitle = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                leavingTitle.addElement(leavingToolBarEl.querySelector('ion-title')); // REVIEW
                const leavingToolBarButtons = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                ...
                const leavingToolBarItems = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                const leavingToolBarItemEls = leavingToolBarEl.querySelectorAll(':scope > *:not(ion-title):not(ion-buttons):not([menuToggle])');
                if (leavingToolBarItemEls.length > 0) {
                    leavingToolBarItems.addElement(leavingToolBarItemEls);
                }
                const leavingToolBarBg = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                leavingToolBarBg.addElement(shadow(leavingToolBarEl).querySelector('.toolbar-background')); // REVIEW
                const leavingBackButton = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                ...
                if (backDirection) {
                    ...
                    leavingToolBarItems.fromTo('transform', `translateX(${CENTER})`, (isRTL ? `translateX(-${SCREEN_WIDTH_PX})` : `translateX(${SCREEN_WIDTH_PX})`));
                    ...
                    if (!translucentHeader) {
                        ...
                        leavingToolBarBg.fromTo('transform', 'translateX(0px)', (isRTL ? `translateX(-${SCREEN_WIDTH_PX})` : `translateX(${SCREEN_WIDTH_PX})`));
                    }
                    if (backButtonEl && !backward) {
                        const leavingBackBtnText = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_0__["createAnimation"])();
                        leavingBackBtnText
                            .addElement(shadow(backButtonEl).querySelector('.button-text')) // REVIEW
...
module.exports = __webpack_require__(/*! /home/runner/work/gauges/gauges/src/main.ts */"./src/main.ts");
