import { Animation, createAnimation, AnimationBuilder } from '@ionic/core';
...
export const mdIosTransitionAnimation = (navEl: HTMLElement, opts: TransitionOptions): Animation => {
  try {
