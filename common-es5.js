...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesTasksServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var defaultTasks = [{
      title: 'Laundry',
      when: [1, 3],
      executions: [new Date(todayInMs - 1 * dayInMs), new Date(todayInMs - 10 * dayInMs)],
      id: '0'
    }, {
      title: 'Hoovering',
      when: [0, 1, 3],
    ...
    var TasksService = /*#__PURE__*/function () {
      function TasksService(notifs) {
        ...
        this.loaded = new Promise(function (resolve) {
          _this2.loadTasks().then(function (tasks) {
            _this2.tasks.next(_models_Task__WEBPACK_IMPORTED_MODULE_3__["default"].parseTasks(tasks));
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 2:
                    return _context5.abrupt("return", this.tasks.getValue().find(function (t) {
                      return t.id === id;
                    }));
                ...
                switch (_context8.prev = _context8.next) {
                  case 0:
                    biggestId = this.tasks.getValue().reduce(function (acc, t) {
                      return parseInt(t.id, 16) > acc ? parseInt(t.id, 16) : acc;
                    }, 0);
                    task.id = (biggestId + 1).toString(16); // TODO: should we copy or just push instead?
              ...
              while (1) {
                switch (_context13.prev = _context13.next) {
                  ...
                  case 3:
                    ...
                    return _context13.abrupt("return", parsed);
